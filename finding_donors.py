...
for i in results:
    print("acc_train : "+i+' : '+str(results[i][2]['acc_train']))
    print("acc_test : "+i+' : '+str(results[i][2]['acc_test']))
...
for i in results:
    print("f_train : "+i+' : '+str(results[i][2]['f_train']))
    print("f_test : "+i+' : '+str(results[i][2]['f_test']))
