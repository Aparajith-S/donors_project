...
Code is provided in the `finding_donors.py` file. You will also be required to use the included `visuals.py` Python file and the `census.csv` dataset file. If you are interested in how the visualizations are created, please feel free to explore this Python file.
